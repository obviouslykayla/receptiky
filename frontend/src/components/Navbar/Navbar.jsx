...
import {faArrowRightFromBracket, faArrowRightToBracket, faBowlFood, faBowlRice, faBreadSlice, faCakeCandles, faGlassWater, faList, faNewspaper, faPlateWheat, faPlus} from   "@fortawesome/free-solid-svg-icons";
...
const Navbar = () => {
  ...
  return (
    <div className='navbar'>
        ...
        <Link to='/savelater'><img src={cart_icon} alt="" className='saveLater'/></Link>
        </ul>
    </div>
  )
}
